...
public class VentanaNormalPlane extends JFrame implements Runnable {
    VentanaNormalPlane(){
        ...
        setTitle("AvionNormal"); //Establecemos el título de la ventana
    ...
    private void colocarEtiquetaTxt() {
        ...
        etiqueta.setText("ESTE ES EL AVION NORMAL");
        ...
        etiqueta2.setText("Nos encontramos ante un avion normal el cual puede ");
        ...
        etiqueta3.setText("transportar a muchos pasajeros pero lentamente, ");
        ...
        etiqueta4.setText("aparte de eso no tiene capacidad de disparo ");
    ...
    private void colocarBotones(){
        ...
        ImageIcon cliaqui2 = new ImageIcon("imagenventanaavnormal.jpg");
