...
public class VentanaModernPlane extends JFrame implements Runnable {
    VentanaModernPlane(){
    ...
    private void colocarEtiquetaTxt() {
        ...
        etiqueta.setText("ESTE ES EL AVION MODERNO");
        ...
        etiqueta2.setText("Nos encontramos ante un avion moderno el cual puede ");
        ...
        etiqueta3.setText("volar a grandes distancias pero con pocos paasajeros, ");
    ...
    private void colocarBotones(){
        ...
        ImageIcon cliaqui2 = new ImageIcon("imagenventanaavmoderno.jpg");
